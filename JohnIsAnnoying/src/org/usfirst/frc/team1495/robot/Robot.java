...
public class Robot extends IterativeRobot {
    ...
    RobotDrive roboDrive = new RobotDrive(RobotMap.frontLeftMotor,RobotMap.backLeftMotor,RobotMap.frontRightMotor,
    		RobotMap.backLeftMotor);
    Joystick stick = new Joystick(RobotMap.stick1);
