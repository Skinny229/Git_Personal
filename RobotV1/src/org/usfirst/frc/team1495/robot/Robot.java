...
import org.usfirst.frc.team1495.robot.subsystems.GattlingGunSubsystem;
...
public class Robot extends IterativeRobot {
	...
	public static final GattlingGunSubsystem ggSubsystem = new GattlingGunSubsystem();
	public static OI oi;
    ...
    public void robotInit() {
		oi = new OI();
		roboDrive = new RobotDrive(RobotMap.RD_LEFT_F,RobotMap.RD_LEFT_B,RobotMap.RD_RIGHT_F,RobotMap.RD_RIGHT_B);
        stick = new Joystick(RobotMap.JOYSTICK_PORT);
        roboDrive.setSafetyEnabled(true);
        ggSubsystem.updateSafety(false);
